            ...
            <div class="row justify-content-center">
                <div class="col-sm-8 py-5">
                    ...
                    <div class="d-flex justify-content-end bd-highlight mb-3">
                        <div class="btn-group" role="group" aria-label="Horizontal Alternate Secondary">
                            @foreach ($post->tags as $tag)
                                <button type="button"
                                    class="btn btn-sm btn btn-outline-secondary text-sm">#{{ $tag->name }}</button>
                            @endforeach
                        </div>
                    </div>
                    @if ($post->photos->count())
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="js-slider slick-dotted-inner slick-dotted-white" data-dots="true"
                                    data-autoplay="true" data-autoplay-speed="3000">
                                    @foreach ($post->photos as $photo)
                                        <div>
                                            <img class="bg-image" src="{{ url($photo->url) }}" alt=""
                    ...
                    @if($post->youtube)
                        ...
                        <div class="container">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/{{$post->youtube}}?autoplay=1"
                                frameborder="0"
